...
use common\helpers\register_script_helper;
use frontend\modules\cms\models\wrx_model_system_basic;
...
<div class="alert alert-danger"> <strong>注意!</strong>
	...
	<a href="' . register_script_helper::getUrlPath('backend/backup')
		. '">【进入数据库管理】
	</a>
</div>
';
...
<div class="row">
	...
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
		...
		<div class="dashboard-stat blue-madison">
			...
			<a class="more" href="<?php //echo Yii::app()->assets->getUrlPath("backend/messagelist"); ?>" id ="car_list">

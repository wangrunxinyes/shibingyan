<?php
$this->title = "房地产大师 | property master";
...
<div class="container">
            <section class="col-2 ss-style-triangles">
                <div class="column text">
                    <h2 class="property-weight-600">挑战一个真正的炒房市场</h2>
                    <img class="property-download property-img-center-first" src="<?php echo $assets->baseUrl; ?>/img/appstore.png">
                    <img class="property-download property-img-center-next" src="<?php echo $assets->baseUrl; ?>/img/googleplay.png">
                </div>
                <div class="column">

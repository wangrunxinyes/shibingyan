					...
					<div class="col-md-9">
						<div class="fileinput fileinput-new" data-provides="fileinput">
							<div class="fileinput-new thumbnail" data="img_0"
								...
								<img id="img_0" src="" alt=""> <input type="hidden"
									id="msg_main_bg">
							</div>
					...
					<div class="col-md-9">
						<div class="input-icon">
							<i class="fa icon-pencil"></i> <input type="hidden"
								id="msg_main_id" value="new"> <input id="msg_main_link"
								class="form-control" placeholder="用户点击消息后要跳转的页面" value="http://"
								type="text">
						</div>
					</div>
				</div>
							...
							<div class="portlet-body form">
								...
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-icon">
												<i class="fa icon-pencil"></i> <input id="weixin_sub_name_1"
													class="form-control" placeholder="请输入消息标题" value="新子菜单"
													type="text">
											</div>
										</div>
									</div>
										...
										<div class="col-md-9">
											<div class="fileinput fileinput-new"
												...
												<div class="fileinput-new thumbnail" data="img_1"
													style="width: 100px; height: 100px; display: none;">
													<img id="img_1" src="" alt=""> <input type="hidden"
														id="msg_bg_1">
												</div>
												<br> <a class="btn default weixin-image-choose"
									...
									<div class="form-group last">
										...
										<div class="col-md-9">
											<div class="input-icon">
												<i class="fa icon-pencil"></i> <input class="weixin-msg-id"
													type="hidden" id="msg_id_1" value="new"> <input
													id="weixin_sub_link_1" class="form-control weixin-sub-link"
													placeholder="用户点击消息后要跳转的页面" value="http://" type="text">
											</div>
										</div>
									</div>

...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa icon-envelope-open"></i> 推送
		</div>
	</div>
			...
			<div class="form-horizontal form-bordered">
				<div class="form-group">
					...
					<div class="col-md-5">
						预览
						<div class="accordion">
							<div style="display: block; width: 280px; height: 155.5px;"
								class="sub-nav active">
								<img src="<?php echo $msg->getValue('bg');?>"
									style="width: 100%; height: 100%; z-index: -1;">
								<div class="html about-me"
									style="height: 50px; width: 280px; background-color: #333; opacity: 0.5; margin-top: -50px;">
					...
					<div class="col-md-5">
						<div class="form-body">
							<div class="form-horizontal form-bordered">
								...
								?>
								<div class="form-group">
									<label class="control-label col-md-5">推送至用户组</label> <br> <select
										class=" col-md-6">
<?php
...
?>
								...
								<div class="form-group last">
									<br> <label class="control-label col-md-5"></label>
									<button class="btn blue weixin-push-msg"
										onclick="return false;">
										<i class="fa fa-plus-square"></i> 推送
									</button>
								</div>

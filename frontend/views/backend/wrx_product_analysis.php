		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-bar-chart font-green-haze"></i> <span
						class="caption-subject bold uppercase font-green-haze">产品种类</span>
			...
			<div class="portlet-body">
				<div id="chart_1" class="chart"
					style="height: 400px; overflow: hidden; text-align: center;"></div>
			</div>
		</div>
	</div>
	<div class="col-md-6">
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-bar-chart font-green-haze"></i> <span
						class="caption-subject bold uppercase font-green-haze">产品</span> <span
						class="caption-helper">近30天统计数据</span>
				</div>
				<div class="tools">
					<a href="javascript:;" class="collapse"></a> <a href="javascript:;"
						class="fullscreen"></a>
...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-bar-chart-o"></i> 统计数据表
		</div>
		<div class="tools">
				...
				<div class="table-scrollable">
					<table role="grid" aria-describedby="datatable_products_info"
						...
						<thead>
							<tr role="row" class="heading">
								...
								<th
									...
									: activate to sort column ascending"
									colspan="1" rowspan="1" aria-controls="datatable_products"
									tabindex="0" class="sorting" width="15%">名称</th>
								<th
									aria-label="
										 weixin_name
									: activate to sort column ascending"
									colspan="1" rowspan="1" aria-controls="datatable_products"
									tabindex="0" class="sorting" width="15%">产品类别</th>
								<th
									aria-label="
										 real_name
									: activate to sort column ascending"
									colspan="1" rowspan="1" aria-controls="datatable_products"
									tabindex="0" class="sorting" width="10%">价格</th>
								<th
									aria-label="
										 create_date
									: activate to sort column ascending"
									colspan="1" rowspan="1" aria-controls="datatable_products"
									tabindex="0" class="sorting" width="15%">点击量</th>
								<th
									aria-label="
										 create_date
									: activate to sort column ascending"
						...
						<tbody class="wrx-table-body">
							<?php
							foreach ( $analysis->getDetails () as $key => $value ) {
								if (is_array ( $value )) {
									echo '

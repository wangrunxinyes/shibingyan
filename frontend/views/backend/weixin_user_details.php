						...
						<div class="portlet-title tabbable-line">
							<div class="caption caption-md">
								<i class="icon-globe theme-font hide"></i> <span
									class="caption-subject font-blue-madison bold uppercase">系统数据</span>
							</div>
						</div>
						<div class="portlet-body">
							<div class="form-group">
								...
								<div class="input-icon">
									<i class="fa fa-male"></i> <input class="form-control"
										value="<?php
										
echo $user->getValue ( 'ip' );
										?>"
										placeholder="未知" disabled="" type="text">
								</div>
							</div>
							<div class="form-group">
								<label>请求次数</label>
								<div class="input-icon">
									<i class="fa fa-phone-square "></i> <input class="form-control"
										value="<?php
										
echo $user->getValue ( 'count' );
										?>" disabled=""
										placeholder="未知" type="text">
								</div>
							</div>
							<div class="form-group">
								<label>最后访问设备</label>
								<div class="input-icon">
									<i class="fa fa-credit-card"></i> <input class="form-control"
										value="<?php echo $type; ?>" placeholder="未知" disabled=""
										type="text">
								</div>
							</div>
							<div class="form-group">
								<label>最后访问时间</label>
								<div class="input-icon">
									<i class="fa  fa-clock-o"></i> <input class="form-control"
										value="<?php echo $last_time; ?>" placeholder="未知" disabled=""
										type="text">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="input-icon">
									<i class="fa  fa-clock-o"></i> <input class="form-control"
										value="<?php echo $create_time; ?>" placeholder="未知"
										disabled="" type="text">
								</div>
							</div>
						</div>
						...
						<div class="portlet-title">
							<div class="caption caption-md">
								<i class="icon-bar-chart theme-font hide"></i> <span
									class="caption-subject font-blue-madison bold uppercase">IP数据</span>
							</div>
						</div>
						<div class="portlet-body">
							<form role="form">

...
echo Yii::app ()->weixin->getId ();
	...
	<div id="fileupload" class="form-horizontal form-bordered">
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="p_name" class="form-control" value="" placeholder=""
					type="text">
			</div>
		</div>
		<div class="form-group">
...
{% } %}
			...
			<div class="col-md-9">
				<div class="fileinput fileinput-new" data-provides="fileinput">
					<div class="fileinput-new thumbnail" data="img_0"
						...
						<img id="img_0" src="" alt=""> <input type="hidden" id="p_main_bg">
					</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="p_introduction" class="form-control" value=""
							...
							<div class="tab-pane fontawesome-demo active" id="tab_1_1">
								...
								<div class="form-horizontal">
										...
										<div class="col-md-9">
											<div class="fileinput fileinput-new"
												...
												<div class="fileinput-new thumbnail" data="img_a"
													...
													<img id="img_a" src="" alt=""> <input id="weixin_sub_img_a"
														type="hidden">
												</div>
											...
											<div class="clearfix margin-top-10">
												<span class="label label-danger">提示</span> 标题背景的建议比例为1:1
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="p_price" class="form-control" value=""
												placeholder="" type="text">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="p_off_details" class="form-control" value=""
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="p_off_price" class="form-control" value=""
												placeholder="" type="text">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="portlet box blue weixin-subdes" style="display:;"
										data="1">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa icon-envelope-letter"></i> <label class="title">新介绍段落</label>
										...
										<div class="portlet-body form">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-6">
														<div class="input-icon">
															<i class="fa icon-pencil"></i> <input
																class="form-control weixin-sub-name"
																id="weixin_sub_name_1" placeholder="请输入消息标题"
																value="新介绍段落" type="text">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-9">
														<div class="fileinput fileinput-new"
															data-provides="fileinput">
															<div class="fileinput-new thumbnail" data="img_1"
																style="width: 180px; height: 120px; display: none;">
																<img id="img_1" src="" alt=""> <input
																	id="weixin_sub_img_1" class="weixin-sub-img"
																	type="hidden">
															</div>
															<br> <a class="btn default weixin-image-choose"
																data-toggle="modal" data="bg_1" href="#responsive">选择图片</a>
															<!-- /.modal -->
														</div>
														<div class="clearfix margin-top-10">
												...
												<div class="form-group last">
													<label class="control-label col-md-3">介绍段落</label>
													<div class="col-md-9">
														<textarea id="weixin_sub_des_1" class="weixin-sub-des"
															name="weixin_sub_des_1"
															style="width: 100%; height: 200px; visibility: hidden;">请输入产品详细介绍</textarea>
													</div>
												</div>
											</div>
...
echo Yii::app ()->assets->getUrlPath ( 'support/item' )?>"
					id="preview_url"> <a id="product_preview" style="display: none;"
...
<script type="text/javascript">
  ...
  sub_des[1] = K.create('textarea[name="weixin_sub_des_1"]', {

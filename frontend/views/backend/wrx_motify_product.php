...
if (! $result || is_null ( $product->getValue ( 'id' ) ) || $product->getValue ( 'id' ) < 1) {
	$this->redirect ( array (
			'backend/deny' 
	) );
}
...
<div class="form-horizontal">
	<input type="hidden" id="des"
		value="<?php echo md5('product' . $code);?>"> <input type="hidden"
		id="p_id" value="<?php echo $code;?>"> <input type="hidden"
		id="uploadUrl"
		value="<?php echo Yii::app()->assets->getUrlPath('backend/upload')?>">
	<input type="hidden" id="indentify"
		value="<?php echo Yii::app()->weixin->getId();?>"> <input
		type="hidden" id="pid" value="<?php echo $product->getValue('id')?>">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="p_name" class="form-control"
					value="<?php echo urldecode($product->getValue('p_name'))?>"
					...
					<div class="row fileupload-buttonbar">
						<div class="col-lg-7" style="width: 100%;">
							...
							<span class="btn btn-success fileinput-button"> <span>选择文件</span>
								...
								id="indentify" value="1" type="hidden"> <input id="uploadUrl"
								value="http://localhost/cms/support/receive" type="hidden"></span>
...
{% } %}
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="fileinput fileinput-new" data-provides="fileinput">
					<div class="fileinput-new thumbnail" data="img_0"
						style="width: 180px; height: 60px;">
						<img id="img_0"
							src="<?php
							
echo Yii::app ()->assets->getUrlPath ( urldecode ( $product->getValue ( 'p_bg' ) ) )?>"
							alt=""> <input type="hidden" id="p_main_bg"
							value="<?php echo urldecode($product->getValue('p_bg'));?>">
					</div>
					<br> <a class="btn default weixin-image-choose" data-toggle="modal"
						data="bg_0" href="#responsive">选择图片</a>
					<!-- /.modal -->
				</div>
				<div class="clearfix margin-top-10">
					<span class="label label-danger">提示</span> 背景图的建议比例为9:3
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="p_introduction" class="form-control"
					value="<?php echo urldecode($product->getValue('p_des'))?>"
					placeholder="" type="text">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-9">
				<textarea id="p_details" name="p_details"
					style="width: 100%; height: 200px; visibility: hidden;">
				...
				<div class="row">
					<div class="tabbable tabbable-custom">
						<ul class="nav nav-tabs">
							...
							<li class="active"><a aria-expanded="true" href="#tab_1_1"
								data-toggle="tab">默认视图</a></li>
							<li class=""><a aria-expanded="false" href="#tab_1_2"
								data-toggle="tab">自定义HTML</a></li>
						</ul>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="fileinput fileinput-new"
												...
												<div class="fileinput-new thumbnail" data="img_a"
													style="width: 100px; height: 100px;">
													<img id="img_a"
														src="<?php
														
echo Yii::app ()->assets->getUrlPath ( urldecode ( $product->getValue ( 'p_photo' ) ) )?>"
														alt=""> <input id="weixin_sub_img_a"
														value="<?php echo urldecode($product->getValue('p_photo'));?>"
														type="hidden">
												</div>
												<br> <a class="btn default weixin-image-choose"
													data-toggle="modal" data="bg_a" href="#responsive">选择图片</a>
												<!-- /.modal -->
											</div>
											<div class="clearfix margin-top-10">
												<span class="label label-danger">提示</span> 产品图片的建议比例为1:1
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="p_price" class="form-control"
												value="<?php echo $product->getValue('p_price')?>"
												placeholder="" type="text">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="p_off_price" class="form-control"
												value="<?php echo $product->getValue('p_off_price')?>"
												placeholder="" type="text">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="checkbox" id='p_off_trigger'>
										</div>
									</div>
									<div class="portlet box blue weixin-subdes"
										style="display: none;" data="0">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa icon-envelope-letter"></i> <label class="title">新介绍段落</label>
											</div>
											<div class="tools">
										...
										<div class="portlet-body form">
											...
											<div class="form-body">
													...
													<div class="col-md-6">
														<div class="input-icon">
															<i class="fa icon-pencil"></i> <input
																class="form-control weixin-sub-name"
																placeholder="请输入消息标题" value="新介绍段落" type="text">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-9">
														<div class="fileinput fileinput-new"
															...
															<div class="fileinput-new thumbnail" data="img_"
																...
																<img id="img_" src="" alt=""> <input
																	class="weixin-sub-img" type="hidden">
															</div>
															<br> <a class="btn default weixin-image-choose"
														...
														<div class="clearfix margin-top-10">
															<span class="label label-danger">提示</span> 介绍图片的建议比例为9:6
														</div>
													</div>
												</div>
												<div class="form-group last">
													...
													<div class="col-md-9">
														<textarea class="weixin-sub-des"
															style="width: 100%; height: 200px; visibility: hidden;">请输入产品详细介绍</textarea>
  ...
  sub_des[' . $index . '] = K.create(\'textarea[name="weixin_sub_des_' . $index . '"]\', {
    allowFileManager: true
									...
									?>
									<button class="btn blue weixin-create-subdes"
										onclick="return false;">
										<i class="fa fa-plus-square"></i> 添加新介绍段落
									</button>
								</div>
							</div>
							<div class="tab-pane glyphicons-demo" id="tab_1_2">
								...
								<textarea name="content"
									style="width: 100%; height: 400px; visibility: hidden;">欢迎使用自定义HTML编辑器</textarea>
							</div>
						</div>
					</div>
				</div>
...
echo Yii::app ()->assets->getUrlPath ( 'support/item' )?>"
					id="preview_url"> <a id="product_preview"
					href="<?php
					
echo Yii::app ()->assets->getUrlPath ( 'support/item/id/' . base64_encode ( $product->getValue ( 'id' ) ) )?>"
					target="_blank" class="btn green btn-lg">预览 </a>
			</div>
...
<div>
	<div id="responsive" class="modal fade" tabindex="-1" data-width="760"
		style="position: fixed; width: 80%; height: 90%; top: 5%; left: 35%">

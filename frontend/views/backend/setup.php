...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-cog"></i> 账户设定
		</div>
	</div>
	<div class="portlet-body">
		<ul class="nav nav-tabs">
			<li class="active"><a aria-expanded="true" href="#tab_1_0"
				data-toggle="tab">新增微信公众号</a></li>
			<li class="dropdown"><a aria-expanded="false" href="#"
				class="dropdown-toggle" data-toggle="dropdown"> 编辑已有公众号 <i
				...
				<ul class="dropdown-menu" role="menu">
					...
					foreach ( $control as $value ) {
						...
						if ($weixin_account->Build ( $value )) {
							...
							echo '
					<li class="">
						<a aria-expanded="false" href="#tab_1_' . $index . '" tabindex="-1" data-toggle="tab">' . $name . '</a>
					</li>
					';
							$index ++;
						}
		...
		<div class="tab-content">
							...
							<tbody>
								<tr>
									<td id="ap_td_new_officeip" style="width: 400px;"><input
										id="content" value="" placeholder="公众号名称"
							...
							<tbody>
								<tr>
									<td id="ap_td_new_officeip" style="width: 400px;"><input
										...
										style="width: 400px;"> &nbsp; <input id="content" value=""
										placeholder="App Secret" style="width: 400px;">&nbsp;</td>
								</tr>
							</tbody>
						</table>
					</li>
			...
			<?php
			foreach ( $weixin_array as $key => $weixin ) {
				echo '

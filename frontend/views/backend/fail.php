	...
	<div class="container">
		...
		<div class="dialog">
			...
			<h2 class="subhead">
				...
				<lable class="description">Access check failed or Internet error|
				验证失败或网络异常</lable>
			</h2>
		...
		<nav class="nav-choices">
			<div class="options">请检查App Key、App Secret和账户激活状态</div>
			...
			<ul>
				...
				<li><a class="btn btn-primary"
					...
					?>"
					id="punch-a-moose">Change Account | 更换账户 </a></li>

...

{
	 ...
	 *        	
	 *        	
	 * @param RedBean_BeanHelper $beanhelper
	 ...
	 *
	 *
	 * @param RedBean_OODBBean $sourceBean
	 ...
	 *
	 *
	 * @param RedBean_OODBBean $otherBean
	 ...
	 *
	 * @param string $property
	 *        	property that needs to be unset
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 *
	 * @param string|RedBean_SQLHelper $sql
...

	{
		...
		if ($oldWith === '') {
			...
			if ($ufbeans instanceof RedBean_OODBBean)
				$ufbeans = array (
						$ufbeans 
				);
		}
	 ...
	 *
	 *
	 * @param string|RedBean_OODBBean $type
...
abstract class RedBean_Observable { // bracket must be here - otherwise coverage software does not understand.
	 ...
	 *        	
	 *        	
	 * @param RedBean_Observer $observer
	 *        	observer instance
	 *        	
	 *        	
	 *        	
...

{
	 ...
	 *      
	 * @param string $table
	 *        	table table to add constrains to
	 *        	
	 *        	
	 *        	
	 * @param string $table1
	 *        	table1 first reference table
	 *        	
	 *        	
	 *        	
	 * @param string $table2
	 *        	table2 second reference table
	 *        	
	 *        	
	 *        	
	 * @param string $property1
	 *        	property1 first column
	 *        	
	 *        	
	 *        	
	 * @param string $property2
	 *        	property2 second column
	 *        	
	 *        	
	 *        	
	 *        	
...

{
	 ...
	 *
	 * @param string $table
	 *        	table to add fk constraints to
	 *        	
	 *        	
	 *        	
	 * @param string $table1
...

{
...

	{
		...
		$index = $this->adapter->getRow ( "SELECT 1 as `exists` FROM db_index WHERE index_name = ? ", array (
				$name 
		) );
...

{
	 ...
	 *
	 *
	 * @param RedBean_OODBBean|RedBean_SimpleModel $embeddedBean
	 *        	the bean or model
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 * @param RedBean_OODBBean $bean
	 *        	bean to extract update values from
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 * @param string $table
	 *        	name of the table to process build commands for
	 *        	
	 *        	
	 *        	
	 * @param string $property
	 *        	name of the property to process build commands for
	 *        	
	 *        	
	 *        	
	 * @param RedBean_OODBBean $bean
	 *        	bean that contains the build commands
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 *
	 * @param RedBean_OODBBean|RedBean_SimpleModel $bean
	 *        	bean to store
	 *        	
	 *        	
	 *        	
...

{
	 ...
	 *        	TRUE returns rows from the link table
	 *        	
	 *        	
	 *        	
	 * @param string $sql
...

	{
		...
		$bean->setMeta ( 'buildcommand.unique', array (
				array (
						$property1,
						$property2 
				) 
		...
		$bean->setMeta ( 'buildcommand.indexes', array (
	 ...
	 *
	 *
	 * @param RedBean_OODBBean|array $beans1
	 *        	one or more beans to form the association
	 *        	
	 *        	
	 *        	
	 * @param RedBean_OODBBean|array $beans2
	 *        	one or more beans to form the association
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 *
	 * @param RedBean_OODBBean|array $bean
	 ...
	 *        	
	 * @param boolean $getLinks
	 *        	whether you are interested in the assoc records
	 *        	
	 *        	
	 *        	
	 * @param string $sql
	 *        	room for additional SQL
	 *        	
	 *        	
	 *        	
	 * @param array $bindings
	 ...
	 *
	 *
	 * @deprecated This method does not seem very useful.
	 *            
	 *            
	 *            
	 *            
	 ...
	 *        	
	 * @param string $type
	 *        	type of bean you are searching for
	 *        	
	 *        	
	 *        	
	 * @param string $sql
	 *        	SQL for extra filtering
	 *        	
	 *        	
	 *        	
	 * @param array $bindings
...

{
...

	{
		...
		list ( $type, $sqlObj ) = (is_array ( $typeInfo ) ? $typeInfo : array (
				$typeInfo,
				array (
						NULL,
						array () 
	 ...
	 *
	 * @param array $beans
	 *        	beans to connect to input beans
	 *        	
	 *        	
	 *        	
	 *        	
...

	{
		...
		foreach ( $filteredBeans as $bean ) {
			...
			$bean->setMeta ( 'sys.input-bean-id', array (
	 ...
	 *        	property (list or bean property)
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *        	last field we've processed
	 *        	
	 *        	
	 *        	
	 * @param array $oldFields
	 *        	list of previously gathered field names
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *        	closure to invoke per bean
	 *        	
	 *        	
	 *        	
	 * @param array $beans
	 *        	beans to iterate over
	 *        	
	 *        	
	 *        	
	 * @param array $retrievals
	 *        	retrievals to send as arguments to closure
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *        	the bean we've retrieved lists for
	 *        	
	 *        	
	 *        	
	 * @param array $list
	 *        	the list we've retrieved for the bean
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 * @param string $type
	 *        	type of beans to load
	 *        	
	 *        	
	 *        	
	 * @param string $sql
	 *        	additional SQL snippet for loading
	 *        	
	 *        	
	 *        	
	 * @param array $bindings
	 ...
	 *        	
	 * @param string $field
	 *        	field to store preloaded beans in
	 *        	
	 *        	
	 *        	
	 *        	
...

	{
		...
		$children = $this->oodb->find ( $type, array (
				$link => $ids 
		), $sql, $bindings );
	 ...
	 *        	
	 * @param array $map
	 *        	mapping to use (children indexed by parent bean ids)
	 *        	
	 *        	
	 *        	
	 * @param string $sql
	 *        	optional SQL snippet for additional filtering
	 *        	
	 *        	
	 *        	
	 * @param array $array
	 *        	optional bindings for SQL snippet
	 *        	
	 *        	
	 *        	
	 *        	
	...
	{
		foreach ( $this->oodb->find ( $type, array (
				'id' => $ids 
		), $sql, $bindings ) as $parent ) {
	 ...
	 *
	 *
	 * @param RedBean_OODBBean|array $beanOrBeans
	 *        	input
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 * @param array $beans
	 *        	beans beans to use as a reference for preloading
	 *        	
	 *        	
	 *        	
	 * @param array|string $types
	 *        	types to load, either string or array
	 *        	
	 *        	
	 *        	
	 *        	
...

{
	...
	/**
	 *
	 * @deprecated Associates two beans and allows you to specify a base bean to form the
	 *            
	 *            
	 *            
	 ...
	 *            
	 * @param RedBean_OODBBean $bean1
	 *        	the first bean you want to associate
	 *        	
	 *        	
	 *        	
	 * @param RedBean_OODBBean $bean2
	 *        	the second bean you want to associate
	 *        	
	 *        	
	 *        	
	 * @param RedBean_OODBBean $baseBean
	 *        	the link bean
	 *        	
	 *        	
	 *        	
	...
	/**
	 *
	 * @deprecated Simplified version of extAssociate().
	 *            
	 *            
	 *            
	 ...
	 *        	
	 * @param mixed $extra
	 *        	one or more additional properties and values
	 *        	
	 *        	
	 *        	
	 *        	
...

{
	 ...
	 *
	 * @param string|PDO $dsn
	 *        	Database Connection String (or PDO instance)
	 *        	
	 *        	
	 *        	
...

{
	 ...
	 *
	 *
	 * @param RedBean_DependencyInjector $di
	 *        	injector to be used
	 *        	
	 *        	
	 *        	
...

{
	 ...
	 *        	name of the next SQL statement/keyword
	 *        	
	 *        	
	 *        	
	 * @param array $args
	 *        	list of statements to be seperated by commas
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *        	One of these 'cell', 'row', 'col' or 'all'.
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 * @param array $array
	 *        	Array with values to generate slots for
	 *        	
	 *        	
	 *        	
	 *        	
...

{
...

	{
		...
		$tags = $this->redbean->find ( 'tag', array (
				'title' => $tags 
		) );
...

{
	...
	/**
	 *
	 * @see RedBean_Finder::find The variation also exports the beans (i.e. it returns arrays).
	 *     
	 *     
	 *     
	 *     
	...
	/**
	 *
	 * @see RedBean_Finder::find This variation returns the first bean only.
	 *     
	 *     
	 *     
	 *     
	...
	/**
	 *
	 * @see RedBean_Finder::find This variation returns the last bean only.
	 *     
	 *     
	 *     
	 *     
	...
	/**
	 *
	 * @see RedBean_Finder::find Convience method. Tries to find beans of a certain type,
	 *     
	 *     
	 *     
	 ...
	 *
	 * @param array $steps
	 *        	(an array representation of a REST path)
	 *        	
	 *        	
	 *        	
	 *        	
...

	{
		...
		for($i = 0; $i < $numberOfSteps; $i += 2) {
			...
			$list = $bean->withCondition ( " {$listType}.id = ? ", array (
					$steps [$i + 1] 
			) )->$listName;
...

{
	 ...
	 *
	 * @param array $array
	 *        	array to be turned into a bean collection
	 *        	
	 *        	
	 *        	
	 * @param boolean $filterEmpty
	 *        	whether you want to exclude empty beans
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *      
	 * @param RedBean_OODBBean $bean1
	 *        	bean that will be part of the association
	 *        	
	 *        	
	 *        	
	 * @param RedBean_OODBBean $bean2
	 ...
	 *        	
	 * @param mixed $extra
	 *        	bean, scalar, array or JSON providing extra data.
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 * @param RedBean_OODBBean|array $bean
	 *        	the bean you have, the reference bean
	 *        	
	 *        	
	 *        	
	 * @param string $type
	 *        	the type of beans you want to search for
	 *        	
	 *        	
	 *        	
	 * @param string $sql
	 ...
	 *
	 * @param RedBean_OODBBean $bean
	 *        	bean you wish to clear many-to-many relations for
	 *        	
	 *        	
	 *        	
	 * @param string $type
	 *        	type of bean you wish to break associations with
	 *        	
	 *        	
	 *        	
	 *        	
	...
	/**
	 *
	 * @see RedBean_Facade::find The findAll() method differs from the find() method in that it does
	 *     
	 *     
	 *     
	...
	/**
	 *
	 * @see RedBean_Facade::find The variation also exports the beans (i.e. it returns arrays).
	 *     
	 *     
	 *     
	 *     
	...
	/**
	 *
	 * @see RedBean_Facade::find This variation returns the first bean only.
	 *     
	 *     
	 *     
	 *     
	...
	/**
	 *
	 * @see RedBean_Facade::find This variation returns the last bean only.
	 *     
	 *     
	 *     
	 *     
	...
	/**
	 *
	 * @see RedBean_Facade::batch Alias for batch(). Batch method is older but since we added so-called *All
	 *     
	 *     
	 *     
	 ...
	 *
	 *
	 * @param array|RedBean_OODBBean $beans
	...
	/**
	 *
	 * @deprecated Given two beans and a property this method will
	 *            
	 *            
	 *            
	 ...
	 *            
	 * @param array $beans
	 *        	beans to swap property values of
	 *        	
	 *        	
	 *        	
	 * @param string $property
	 *        	property whose value you want to swap
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 *
	 * @see RedBean_Facade::preload Usage: R::preload($books, array('coauthor'=>'author'));
	 *     
	 *     
	 *     
	 *     
...

{
	 ...
	 *
	 * @param string $id
	 *        	request ID, identification for request
	 *        	
	 *        	
	 *        	
	 * @param string $beanType
	 *        	type of the bean you want to store
	 *        	
	 *        	
	 *        	
	 * @param array $data
	 ...
	 *        	
	 * @param array $data
	 *        	data array containing the ID of the bean to load
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *        	
	 * @param string $beanType
	 *        	type of the bean you want to delete
	 *        	
	 *        	
	 *        	
	 * @param array $data
	 ...
	 *        	
	 * @param string $beanType
	 *        	type of the bean you want to export
	 *        	
	 *        	
	 *        	
	 * @param array $data
...

	{
		...
		$array = RedBean_Facade::exportAll ( array (
				$bean 
		), TRUE );
	 ...
	 *        	
	 * @param string $action
	 *        	action you want to invoke on bean model
	 *        	
	 *        	
	 *        	
	 * @param array $data
...

	{
		...
		return $this->resp ( call_user_func_array ( array (
				$beanModel,
				$action 
		), $data ), $id );
	}
	 ...
	 *        	JSON array containing the details
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *        	
	 * @param string $beanType
	 *        	type of the bean you wish to apply the action to
	 *        	
	 *        	
	 *        	
	 * @param string $action
	 ...
	 *        	
	 * @param array $data
	 *        	data array containing parameters or details
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *        	a white list of beans and methods that should be accessible through the BeanCan Server.
	 *        	
	 *        	
	 *        	
	 *        	
...

{
...

	{
		...
		$answer = call_user_func_array ( array (
				$this->bean,
				$this->method 
		), $this->payload ['param'] );
	...
	{
		$sqlBundleItem = (isset ( $this->sqlSnippets [$this->list] )) ? $this->sqlSnippets [$this->list] : array (
				NULL,
				array () 
		);
	 ...
	 *
	 *
	 * @param RedBean_OODBBean $root
	 *        	root bean for REST action
	 *        	
	 *        	
	 *        	
	 * @param string $uri
	 *        	the URI of the RESTful operation
	 *        	
	 *        	
	 *        	
	 * @param string $method
	 *        	the method you want to apply
	 *        	
	 *        	
	 *        	
	 * @param array $payload
	 ...
	 *        	
	 *        	
	 * @param array $sqlSnippets
	 *        	a bundle of SQL snippets to use
	 *        	
	 *        	
	 *        	
	 *        	
...

{
	 ...
	 *
	 *
	 * @param RedBean_Observable $adapter
	 *        	the adapter you want to attach to
	 *        	
	 *        	
	 *        	
	 *        	
...

{
	 ...
	 *
	 * @param array $array
	 *        	data array to import as a bean
	 *        	
	 *        	
	 *        	
	 * @param boolean $filterEmpty
	 *        	if TRUE empty STRING values are converted to NULL (default FALSE)
	 *        	
	 *        	
	 *        	
	 *        	
	 ...
	 *
	 * @param array $array
	 *        	data array to import as a list
	 *        	
	 *        	
	 *        	
	 * @param boolean $filterEmpty
	 *        	if TRUE empty lists will NOT be imported
	 *        	
	 *        	
	 *        	
	 *        	
...
class RedBean_Plugin_TimeLine extends RedBean_Plugin_QueryLogger implements RedBean_Plugin {
	 ...
	 *        	path to file to write schema changes to.
	 *        	
	 *        	
	 *        	
	 */
...

{
	 ...
	 *        	name of the dependency (should match setter)
	 *        	
	 *        	
	 *        	
...

{
	...
	{
		return in_array ( RedBean_QueryWriter_AQueryWriter::getAssocTableFormat ( array (
				$type,
				$target 
		) ), $this->tables );
	}

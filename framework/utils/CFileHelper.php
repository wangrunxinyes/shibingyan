...
class CFileHelper {
	 ...
	 * @param array $options
	 *        	for the directory removal. Valid options are:
	 *        	<ul>
	 ...
	 *        	the destination directory
	 * @param string $base
	 *        	the path relative to the original source directory
	 * @param array $fileTypes
	 *        	list of file name suffix (without dot). Only files with these suffixes will be copied.
	 * @param array $exclude
	 *        	list of directory and file exclusions. Each exclusion can be either a name or a path.
	 *        	If a file or directory name or path matches the exclusion, it will not be copied. For example, an exclusion of
	 *        	'.svn' will exclude all files and directories whose name is '.svn'. And an exclusion of '/a/b' will exclude
	 *        	file or directory '$src/a/b'. Note, that '/' should be used as separator regardless of the value of the DIRECTORY_SEPARATOR constant.
	 * @param integer $level
	 *        	recursion depth. It defaults to -1.
	 *        	Level -1 means copying all directories and files under the directory;
	 *        	Level 0 means copying only the files DIRECTLY under the directory;
	 *        	level N means copying those directories that are within N levels.
	 * @param array $options
	 ...
	 *        	the path relative to the original source directory
	 * @param array $fileTypes
	 *        	list of file name suffix (without dot). Only files with these suffixes will be returned.
	 * @param array $exclude
	 *        	list of directory and file exclusions. Each exclusion can be either a name or a path.
	 *        	If a file or directory name or path matches the exclusion, it will not be copied. For example, an exclusion of
	 *        	'.svn' will exclude all files and directories whose name is '.svn'. And an exclusion of '/a/b' will exclude
	 ...
	 *        	Level 0 means searching for only the files DIRECTLY under the directory;
	 *        	level N means searching for those directories that are within N levels.
	 * @param boolean $absolutePaths
	 *        	whether to return absolute paths or relative ones
	 ...
	 * @param array $fileTypes
	 *        	list of valid file name suffixes (without dot).
	 * @param array $exclude
	 *        	list of directory and file exclusions. Each exclusion can be either a name or a path.
	 ...
	 *        	whether to check the file extension in case the MIME type cannot be determined
	 ...
	 *        	the file name.
	 * @param string $magicFile
	 *        	the path of the file that contains all available MIME type information.
	 ...
	 *        	the file name.
	 * @param string $magicFile
	 *        	the path of the file that contains all available extension information.
	...
	/**
	 * Shared environment safe version of mkdir.
	 ...
	 *        	path to be created
	 * @param integer $mode
	 *        	the permission to be set for newly created directories, if not set - 0777 will be used
	 * @param boolean $recursive
	 *        	whether to create directory structure recursive if parent dirs do not exist

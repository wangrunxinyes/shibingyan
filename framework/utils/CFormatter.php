...
class CFormatter extends CApplicationComponent {
	 ...
	 * @param string $type
	 *        	the data type. This must correspond to a format method available in CFormatter.
	 ...
	 *        	whether newlines should be converted to HTML &lt;p&gt;&lt;/p&gt; tags,
	 *        	false by default meaning that HTML &lt;br /&gt; tags will be used
	 * @param boolean $removeEmptyParagraphs
	 *        	whether empty paragraphs should be removed, defaults to true;
	 ...
	 * 
	 * @param mixed $time
	 *        	the time expression to be normalized
	 ...
	 *        	if full names should be used (e.g. bytes, kilobytes, ...).

...
class CDateFormatter extends CComponent {
	 ...
	 * 
	 * @param mixed $locale
	 *        	locale ID (string) or CLocale instance
	 */
	 ...
	 *        	the pattern (See {@link http://www.unicode.org/reports/tr35/tr35-dates.html#Date_Format_Patterns})
	 * @param mixed $time
	 *        	UNIX timestamp or a string in strtotime format
	 ...
	 *        	width of the date pattern. It can be 'full', 'long', 'medium' and 'short'.
	 *        	If null, it means the date portion will NOT appear in the formatting result
	 * @param string $timeWidth
	 *        	width of the time pattern. It can be 'full', 'long', 'medium' and 'short'.
	 ...
	 *        	a pattern.
	 * @param array $date
	 *        	result of {@link CTimestamp::getdate}.
	...
	/**
	 * Get day of week in the month, e.g.
	 * 2nd Wed in July.
	 * 
	 * @param string $pattern
	 *        	a pattern.
	...
	/**
	 * Get the hours in 24 hour format, i.e.
	 * [0-23].
	...
	/**
	 * Get the era.
	 * i.e. in gregorian, year > 0 is AD, else BC.
	 * 
	 * @param string $pattern
	 *        	a pattern.
	 * @param array $date

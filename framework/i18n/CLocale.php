...
class CLocale extends CComponent {
	...
	protected function __construct($id) {
		...
		if (is_file ( $dataFile ))
			...
			throw new CException ( Yii::t ( 'yii', 'Unrecognized locale "{locale}".', array (
					'{locale}' => $id 
			) ) );
	}
	 ...
	 *        	whether the month name should be returned in stand-alone format
	 ...
	 *        	month name width. It can be 'wide', 'abbreviated' or 'narrow'.
	 * @param boolean $standAlone
	 *        	whether the month names should be returned in stand-alone format
	 ...
	 *
	 * @param integer $day
	 *        	weekday (0-7, 0 and 7 means Sunday)
	 * @param string $width
	 *        	weekday name width. It can be 'wide', 'abbreviated' or 'narrow'.
	 * @param boolean $standAlone
	 *        	whether the week day name should be returned in stand-alone format
	 ...
	 *        	era (0,1)
	 * @param string $width
	 *        	era name width. It can be 'wide', 'abbreviated' or 'narrow'.
	 ...
	 *
	 * @param string $width
	 *        	date format width. It can be 'full', 'long', 'medium' or 'short'.
	 ...
	 *
	 * @param string $width
	 *        	time format width. It can be 'full', 'long', 'medium' or 'short'.
	 * @return string date format
	 */
	 ...
	 *
	 * @param string $id
	 *        	array key from an array named by $category.
	 * @param string $category
	 *        	data category. One of 'languages', 'scripts' or 'territories'.
	 ...
	 *
	 * @param string $id
	 *        	Unicode language identifier from IETF BCP 47. For example, the code "en_US" represents U.S. English and "en_GB" represents British English.
	 ...
	 *
	 * @param string $id
	 *        	Unicode script identifier from IETF BCP 47. For example, the code "en_US" represents U.S. English and "en_GB" represents British English.
	 ...
	 *
	 * @param string $id
	 *        	Unicode territory identifier from IETF BCP 47. For example, the code "en_US" represents U.S. English and "en_GB" represents British English.

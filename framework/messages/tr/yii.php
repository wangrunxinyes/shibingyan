...
return array (
		...
		'Invalid enumerable value "{value}". Please make sure it is among ({enum}).' => "{value}",
		'geçersiz sayılabilir(enumerable) değer. Lütfen bu aralıkta olduğuna emin olun ({enum}).',

...
abstract class CModule extends CComponent {
	 ...
	 * @param mixed $config
	 *        	the module configuration. It can be either an array or
	 ...
	 * 
	 * @param string $name
	 *        	application component or property name
	...
	public function setBasePath($path) {
		if (($this->_basePath = realpath ( $path )) === false || ! is_dir ( $this->_basePath ))
			throw new CException ( Yii::t ( 'yii', 'Base path "{path}" is not a valid directory.', array (
					'{path}' => $path 
			) ) );
	}
	 ...
	 * 
	 * @param array $value
	 *        	user-defined parameters. This should be in name-value pairs.
	 */
	 ...
	 * 
	 * @param string $value
	 *        	the directory that contains the application modules.
	 * @throws CException if the directory is invalid
	 */
	public function setModulePath($value) {
		if (($this->_modulePath = realpath ( $value )) === false || ! is_dir ( $this->_modulePath ))
			throw new CException ( Yii::t ( 'yii', 'The module path "{path}" is not a valid directory.', array (
					'{path}' => $value 
			) ) );
	}
	 ...
	 *        	list of aliases to be defined. The array keys are root aliases,
	 *        	while the array values are paths or aliases corresponding to the root aliases.
	 *        	For example,
	 *        	<pre>
	 *        	array(
	 ...
	 * 
	 * @param string $id
	 *        	application module ID (case-sensitive)
	 ...
	 * @param boolean $merge
	 *        	whether to merge the new module configuration
	 ...
	 * 
	 * @param string $id
	 *        	application component ID (case-sensitive)
	 * @param boolean $createIfNull
	 *        	whether to create the component if it doesn't exist yet.
	 ...
	 *        	whether to return the loaded components only. If this is set false,
	 ...
	 *        	application components(id=>component configuration or instances)
	 * @param boolean $merge
	 *        	whether to merge the new component configuration with the existing one.

...
interface IWebServiceProvider {
	 ...
	 *        	the currently requested Web service.
...
interface IUserIdentity {
	...
	public function getId();
	/**
	 * Returns the display name for the identity (e.g.
	 * username).
	 * 
...
interface IAuthManager {
	 ...
	 *        	the name of the operation that we are checking access to
	 * @param mixed $userId
	 *        	the user ID. This should be either an integer or a string representing
	 ...
	 * @param array $params
	 *        	additional parameters to be passed to the business rule when being executed.
	 * @param mixed $data
	 *        	additional data that is associated with the corresponding authorization item or assignment

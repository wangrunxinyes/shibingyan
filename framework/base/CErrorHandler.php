...
class CErrorHandler extends CApplicationComponent {
	 ...
	 * 
	 * @param CEvent $event
	 *        	the event containing the exception/error information
	 */
				...
				if (function_exists ( 'header_remove' )) // php >= 5.3
{
	 ...
	 * 
	 * @param string $view
	 *        	the view name (file name without extension).
	 ...
	 * 
	 * @param string $view
	 *        	view name (either 'exception' or 'error')
	 * @param integer $code
	 *        	HTTP status code
	 ...
	 *        	the language that the view file is in
	 * @return string view file path
	 */
	 ...
	 *        	replacement error string that is returned if code is unknown

...
class CDbCacheDependency extends CCacheDependency {
	 ...
	 * 
	 * @param string $sql
	 *        	the SQL statement whose result is used to determine if the dependency has been changed.
	 */
	...
	protected function getDbConnection() {
		if ($this->_db !== null)
			...
			if (($this->_db = Yii::app ()->getComponent ( $this->connectionID )) instanceof CDbConnection)
				...
				throw new CException ( Yii::t ( 'yii', 'CDbCacheDependency.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.', array (

...
class CFileCache extends CCache {
	 ...
	 * 
	 * @param boolean $expiredOnly
	 *        	whether only expired cache files should be removed.
	 *        	If false, all cache files under {@link cachePath} will be removed.
	 * @param string $path
	 *        	the path to clean with. If null, it will be {@link cachePath}.
	 */
	 ...
	 * {@link $embedExpiry} aware.
	 * 
	 * @param string $path
	 *        	to the file, modification time to be retrieved from.

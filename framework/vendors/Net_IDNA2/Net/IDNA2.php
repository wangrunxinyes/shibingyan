...
class Net_IDNA2 {
	 ...
	 *
	 * @param array $options
	 *        	Options to initialise the object with
	 *        	
	 * @access public
	 * @see setParams()
	 */
	 ...
	 *        	Domain name (UTF-8 or UCS-4)
	 * @param string $one_time_encoding
	 *        	Desired input encoding, see {@link set_parameter}
	 ...
	 *
	 * @param string $input
	 *        	Domain name (ACE string)
	 * @param string $one_time_encoding
	 *        	Desired output encoding, see {@link set_parameter}
	 *        	
	 ...
	 *
	 * @param array $parts_arr
	 *        	parts (strings) as returned by parse_url()
	 *        	
	 * @return string
	 * @access private
	 */
	 ...
	 *
	 * @param string $decoded
	 *        	Decoded string which should be encoded
	 *        	
	 ...
	 *        	Encoded string which should be decoded
	 *        	
	 ...
	 * @param array $input
	 *        	UCS4 sequence
	 * @param boolean $include_bit
	 *        	Include bitmask in output
	 *        	
	 * @return void
	 * @static
	 *

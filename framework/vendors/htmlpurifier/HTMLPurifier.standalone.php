...
class HTMLPurifier_AttrTypes {
	 ...
	 * @param string $type
	 *        	String type name
	 * @param HTMLPurifier_AttrDef $impl
 ...
 * Doesn't manage required attributes
...
abstract class HTMLPurifier_Definition {
	 ...
	 * setup.
	 * This will be true only if all invocations to get a raw
...
class HTMLPurifier_CSSDefinition extends HTMLPurifier_Definition {
	...
	protected function doSetup($config) {
		$this->info ['text-align'] = new HTMLPurifier_AttrDef_Enum ( array (
				'left',
				'right',
				'center',
				'justify' 
		...
		$border_style = $this->info ['border-bottom-style'] = $this->info ['border-right-style'] = $this->info ['border-left-style'] = $this->info ['border-top-style'] = new HTMLPurifier_AttrDef_Enum ( array (
				'none',
				'hidden',
				'dotted',
				'dashed',
		...
		$this->info ['clear'] = new HTMLPurifier_AttrDef_Enum ( array (
				'none',
				'left',
				'right',
				'both' 
		), false );
		$this->info ['float'] = new HTMLPurifier_AttrDef_Enum ( array (
				'none',
				'left',
				'right' 
		), false );
		$this->info ['font-style'] = new HTMLPurifier_AttrDef_Enum ( array (
				'normal',
				'italic',
				'oblique' 
		), false );
		$this->info ['font-variant'] = new HTMLPurifier_AttrDef_Enum ( array (
				'normal',
				'small-caps' 
		), false );
		
		$uri_or_none = new HTMLPurifier_AttrDef_CSS_Composite ( array (
		...
		$this->info ['list-style-position'] = new HTMLPurifier_AttrDef_Enum ( array (
				'inside',
				'outside' 
		), false );
		$this->info ['list-style-type'] = new HTMLPurifier_AttrDef_Enum ( array (
				'disc',
				'circle',
				'square',
				'decimal',
		...
		$this->info ['text-transform'] = new HTMLPurifier_AttrDef_Enum ( array (
				'capitalize',
				'uppercase',
				'lowercase',
				'none' 
		...
		$this->info ['background-repeat'] = new HTMLPurifier_AttrDef_Enum ( array (
				'repeat',
				'repeat-x',
				'repeat-y',
				'no-repeat' 
		) );
		$this->info ['background-attachment'] = new HTMLPurifier_AttrDef_Enum ( array (
				'scroll',
				'fixed' 
		) );
		$this->info ['background-position'] = new HTMLPurifier_AttrDef_CSS_BackgroundPosition ();
		
		$border_color = $this->info ['border-top-color'] = $this->info ['border-bottom-color'] = $this->info ['border-left-color'] = $this->info ['border-right-color'] = $this->info ['background-color'] = new HTMLPurifier_AttrDef_CSS_Composite ( array (
				new HTMLPurifier_AttrDef_Enum ( array (
						'transparent' 
				) ),
		...
		$margin = $this->info ['margin-top'] = $this->info ['margin-bottom'] = $this->info ['margin-left'] = $this->info ['margin-right'] = new HTMLPurifier_AttrDef_CSS_Composite ( array (
				new HTMLPurifier_AttrDef_CSS_Length (),
				new HTMLPurifier_AttrDef_CSS_Percentage (),
				new HTMLPurifier_AttrDef_Enum ( array (
						'auto' 
		...
		// non-negative
		$padding = $this->info ['padding-top'] = $this->info ['padding-bottom'] = $this->info ['padding-left'] = $this->info ['padding-right'] = new HTMLPurifier_AttrDef_CSS_Composite ( array (
				new HTMLPurifier_AttrDef_CSS_Length ( '0' ),
				new HTMLPurifier_AttrDef_CSS_Percentage ( true ) 
		) );
		...
		$this->info ['width'] = $this->info ['height'] = $max === null ? $trusted_wh : new HTMLPurifier_AttrDef_Switch ( 'img', 
				// For img tags:
		...
		$this->info ['font-weight'] = new HTMLPurifier_AttrDef_Enum ( array (
				'normal',
				'bold',
				'bolder',
				'lighter',
		...
		// in THE FUTURE!
		$this->info ['white-space'] = new HTMLPurifier_AttrDef_Enum ( array (
				'nowrap',
				'normal',
				'pre',
				'pre-wrap',
	...
	protected function doSetupProprietary($config) {
		...
		// more CSS3
		$this->info ['page-break-after'] = $this->info ['page-break-before'] = new HTMLPurifier_AttrDef_Enum ( array (
				'auto',
				'always',
				'avoid',
				'left',
		...
		$this->info ['page-break-inside'] = new HTMLPurifier_AttrDef_Enum ( array (
				'auto',
				'avoid' 
		) );
	}
	...
	protected function doSetupTricky($config) {
		...
		$this->info ['overflow'] = new HTMLPurifier_AttrDef_Enum ( array (
				'visible',
				'hidden',
				'auto',
				'scroll' 
	...
	protected function doSetupTrusted($config) {
		...
		$this->info ['top'] = $this->info ['left'] = $this->info ['right'] = $this->info ['bottom'] = new HTMLPurifier_AttrDef_CSS_Composite ( array (
				new HTMLPurifier_AttrDef_CSS_Length (),
				new HTMLPurifier_AttrDef_CSS_Percentage (),
				new HTMLPurifier_AttrDef_Enum ( array (
						'auto' 
...
class HTMLPurifier_Config {
	 ...
	 *        	
	 * @return string @note Revision is handled specially and is removed from the batch
	 *         before processing!
	 */
...
class HTMLPurifier_ConfigSchema {
	 ...
	 * @param string $type
	 *        	Allowed type of the directive. See
...
$config->getBatchSerial ( $this->type ) . ',' . $config->get ( $this->type . '.DefinitionRev' );
	}
	 ...
	 * @note Be carefuly implementing this method as flush.
	 * Flush must
...
class HTMLPurifier_DefinitionCacheFactory {
	 ...
	 * 
	 * @param HTMLPurifier_DefinitionCache_Decorator|string $decorator
...
class HTMLPurifier_ElementDef {
	 ...
	 * 
	 * @param $a1 Array
	 *        	by reference that is merged into
	 * @param $a2 Array
	 *        	that merges into $a1
	 */
...
class HTMLPurifier_Encoder {
	 ...
	 * @return string @note Just for reference, the non-SGML code points are 0 to 31 and
					...
					if (($in <= 31 || $in == 127) && ! ($in == 9 || $in == 13 || $in == 10)) // save \r\t\n
{
				...
				if (0x80 == (0xC0 & ($in))) {
					...
					if (0 == -- $mState) {
						...
						(0x9 == $mUcs4 || 0xA == $mUcs4 || 0xD == $mUcs4 || (0x20 <= $mUcs4 && 0x7E >= $mUcs4) || 
	 ...
	 * @param HTMLPurifier_Config $config        	
	 * @param HTMLPurifier_Context $context        	
	 * @return string @note Currently, this is a lossy conversion, with unexpressable
	 ...
	 * encoding supports ASCII.
	 * 7/8-bit encodings like Shift_JIS will
...
class HTMLPurifier_EntityLookup {
	 ...
	 * 
	 * @param bool|HTMLPurifier_EntityLookup $prototype
...
class HTMLPurifier_EntityParser {
	 ...
	 * @type array
	 */
	protected $_special_dec2str = array (
			34 => '"',
			38 => '&',
			39 => "'",
			60 => '<',
	 ...
	 * @type array
	 */
	protected $_special_ent2dec = array (
			'quot' => 34,
			'amp' => 38,
			'lt' => 60,
			'gt' => 62 
	...
	public function substituteNonSpecialEntities($string) {
		...
		return preg_replace_callback ( $this->_substituteEntitiesRegex, array (
				$this,
	...
	protected function specialEntityCallback($matches) {
		...
		if ($is_num) {
			...
			return isset ( $this->_special_ent2dec [$matches [3]] ) ? $this->_special_ent2dec [$matches [3]] : $entity;
		}
	}
}
 ...
 * They can contain error structs (which apply
...
class HTMLPurifier_ErrorStruct {
	 ...
	 * Note that top-level structures
...
class HTMLPurifier_Generator {
	...
	public function generateFromToken($token) {
		if (! $token instanceof HTMLPurifier_Token) {
			...
			$attr = $this->generateAttributes ( $token->attr, $token->name );
			return '<' . $token->name . ($attr ? ' ' : '') . $attr . ($this->_xhtml ? ' /' : '') . // <br /> v. <br>
'>';
...
class HTMLPurifier_HTMLModule {
	 ...
	 * More rarely used for adding attributes to
	 ...
	 * the HTMLPurifier_ElementDef class.
	 ...
	 *        	Allowed children in form of:
	 *        	"$content_model_type: $content_model"
	 * @return array @note If contents is an object, an array of two nulls will be
...
class HTMLPurifier_HTMLModuleManager {
	 ...
	 * indexed by module's class name.
	 * This array is usually lazy loaded, but a
	...
	public function __construct() {
		...
		$this->doctypes->register ( 'HTML 4.01 Transitional', false, array_merge ( $common, $transitional, $non_xml ), array (
				'Tidy_Transitional',
				'Tidy_Proprietary' 
		), array (), '-//W3C//DTD HTML 4.01 Transitional//EN', 'http://www.w3.org/TR/html4/loose.dtd' );
		
		$this->doctypes->register ( 'HTML 4.01 Strict', false, array_merge ( $common, $non_xml ), array (
				'Tidy_Strict',
				'Tidy_Proprietary',
				'Tidy_Name' 
		), array (), '-//W3C//DTD HTML 4.01//EN', 'http://www.w3.org/TR/html4/strict.dtd' );
		...
		$this->doctypes->register ( 'XHTML 1.0 Transitional', true, array_merge ( $common, $transitional, $xml, $non_xml ), array (
				...
				'Tidy_Proprietary',
				'Tidy_Name' 
		), array (), '-//W3C//DTD XHTML 1.0 Transitional//EN', 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd' );
		
		$this->doctypes->register ( 'XHTML 1.0 Strict', true, array_merge ( $common, $xml, $non_xml ), array (
				'Tidy_Strict',
				'Tidy_XHTML',
				'Tidy_Strict',
				'Tidy_Proprietary',
				'Tidy_Name' 
		), array (), '-//W3C//DTD XHTML 1.0 Strict//EN', 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd' );
		
		$this->doctypes->register ( 'XHTML 1.1', true, 
				// Iframe is a real XHTML 1.1 module, despite being
				// "transitional"!
				array_merge ( $common, $xml, array (
						'Ruby',
						'Iframe' 
				) ), array (
						'Tidy_Strict',
...
array (), '-//W3C//DTD XHTML 1.1//EN', 'http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd' );
	 ...
	 * 
	 * @param $module Mixed:
	 *        	string module name, with or without
	 *        	HTMLPurifier_HTMLModule prefix, or instance of
	 *        	subclass of HTMLPurifier_HTMLModule.
	 * @param $overload Boolean
	 *        	whether or not to overload previous modules.
...
abstract class HTMLPurifier_Injector {
	 ...
	 * need to be allowed by the definition.
	 * Takes form of
	 ...
	 * the injector.
	 * This function also checks if the HTML environment
...
class HTMLPurifier_Language {
	 ...
	 * Check this if you'd like to notify the
...
class HTMLPurifier_LanguageFactory {
	 ...
	 * @type array
	 */
	protected $mergeable_keys_map = array (
			'messages' => true,
			'errorNames' => true 
	);
...
class HTMLPurifier_Length {
	 ...
	 * @return HTMLPurifier_Length @warning Does not perform validation.
	 */
	 ...
	 * @return int @warning If both values are too large or small, this calculation will
	 *         not work properly
	 */
...
class HTMLPurifier_Lexer {
	...
	protected static function escapeCDATA($string) {
		return preg_replace_callback ( '/<!\[CDATA\[(.+?)\]\]>/s', array (
				'HTMLPurifier_Lexer',
				'CDATACallback' 
		), $string );
	}
...
'', $string );
	 ...
	 * 
	 * @param array $matches
	 *        	PCRE matches array, with index 0 the entire match
...
abstract class HTMLPurifier_Node {
	 ...
	 * is null if it is not necessary.
...
class HTMLPurifier_PropertyList {
	 ...
	 * 
	 * @param HTMLPurifier_PropertyList $plist
	 *        	Parent plist
	 */
 ...
 * The basic idea is to maintain two
...
class HTMLPurifier_URI {
	 ...
	 * the current context.
	 * This is true when the host is null, or
...
abstract class HTMLPurifier_URIScheme {
	 ...
	 * explicitly specified, ala file:///path/to/file.
	 * As of writing,
...
class HTMLPurifier_URISchemeRegistry {
	 ...
	 * 
	 * @param HTMLPurifier_URISchemeRegistry $prototype
	 *        	Optional prototype to overload sole instance with,
	 *        	or bool true to reset to default registry.
	 * @return HTMLPurifier_URISchemeRegistry @note Pass a registry object $prototype with a compatible interface and
...
class HTMLPurifier_VarParser {
	 ...
	 * Mainly for backwards compatibility, but
 ...
 * a focus that can be efficiently manipulated.
 * It is known as
...
class HTMLPurifier_Zipper {
	 ...
	 * the hole with a value.
	 * (Usually you should supply a $t, unless you
...
class HTMLPurifier_AttrDef_Integer extends HTMLPurifier_AttrDef {
	 ...
	 *
	 * @param $negative Bool
	 *        	indicating whether or not negative values are allowed
	 * @param $zero Bool
	 *        	indicating whether or not zero is allowed
	 * @param $positive Bool
	 *        	indicating whether or not positive values are allowed
	 */
...
class HTMLPurifier_AttrDef_Switch {
	 ...
	 * @param HTMLPurifier_AttrDef $with_tag
	 *        	Call if token matches tag
	 * @param HTMLPurifier_AttrDef $without_tag
...
class HTMLPurifier_AttrDef_CSS_Number extends HTMLPurifier_AttrDef {
	 ...
	 *        	indicates whether negatives are forbidden
	 */
	 ...
	 * @param HTMLPurifier_Config $config        	
	 * @param HTMLPurifier_Context $context        	
	 * @return string|bool @warning Some contexts do not pass $config, $context. These
...
class HTMLPurifier_AttrDef_CSS_Composite extends HTMLPurifier_AttrDef {
	...
	/**
	 *
	 * @param HTMLPurifier_AttrDef[] $defs
...
class HTMLPurifier_AttrDef_CSS_DenyElementDecorator extends HTMLPurifier_AttrDef {
	...
	/**
	 *
	 * @param HTMLPurifier_AttrDef $def
	 *        	Definition to wrap
	 * @param string $element
	 *        	Element to deny
	 */
 ...
 * @note Currently supports the alpha filter.
...
class HTMLPurifier_AttrDef_CSS_Multiple extends HTMLPurifier_AttrDef {
	...
	/**
	 *
	 * @param HTMLPurifier_AttrDef $single
...
class HTMLPurifier_AttrDef_HTML_Class extends HTMLPurifier_AttrDef_HTML_Nmtokens {
	...
	protected function filter($tokens, $config, $context) {
		...
		$ret = array ();
		foreach ( $tokens as $token ) {
			if (($allowed === null || isset ( $allowed [$token] )) && ! isset ( $forbidden [$token] ) && 
 ...
 * because of a missing alt tag.
 * This needs to be registered as both
...
class HTMLPurifier_AttrTransform_SafeParam extends HTMLPurifier_AttrTransform {
	...
	public function __construct() {
		...
		$this->wmode = new HTMLPurifier_AttrDef_Enum ( array (
				'window',
				'opaque',
				'transparent' 
		) );
...
class HTMLPurifier_ChildDef_Custom extends HTMLPurifier_ChildDef {
	...
	/**
	 *
	 * @param $dtd_regex Allowed
	 *        	child pattern from the DTD
	 */
...
class HTMLPurifier_ChildDef_StrictBlockquote extends HTMLPurifier_ChildDef_Required {
	 ...
	 *
	 * @param HTMLPurifier_Config $config        	
	 * @return array @note We don't want MakeWellFormed to auto-close inline elements since
 ...
 * The general idea is to extract out all of the
...
class HTMLPurifier_DefinitionCache_Decorator extends HTMLPurifier_DefinitionCache {
	 ...
	 * 
	 * @param HTMLPurifier_DefinitionCache $cache
 ...
 * declare directionality of content.
...
class HTMLPurifier_HTMLModule_Bdo extends HTMLPurifier_HTMLModule {
	 ...
	 */
	public function setup($config) {
		$bdo = $this->addElement ( 'bdo', 'Inline', 'Inline', array (
				'Core',
				'Lang' 
		), array (
				'dir' => 'Enum#ltr,rtl' 
...
class HTMLPurifier_HTMLModule_Forms extends HTMLPurifier_HTMLModule {
	 ...
	 */
	public function setup($config) {
		$form = $this->addElement ( 'form', 'Form', 'Required: Heading | List | Block | fieldset', 'Common', array (
				'accept' => 'ContentTypes',
		...
		$button->excludes = $this->makeLookup ( 'form', 'fieldset', // Form
...
class HTMLPurifier_HTMLModule_Legacy extends HTMLPurifier_HTMLModule {
	 ...
	 */
	public function setup($config) {
		$this->addElement ( 'basefont', 'Inline', 'Empty', null, array (
				'color' => 'Color',
		...
		$this->addElement ( 'font', 'Inline', 'Inline', array (
				'Core',
				'I18N' 
		), array (
				'color' => 'Color',
...
class HTMLPurifier_HTMLModule_Proprietary extends HTMLPurifier_HTMLModule {
	 ...
	 */
	public function setup($config) {
		$this->addElement ( 'marquee', 'Inline', 'Flow', 'Common', array (
...
/**
 * A "safe" embed module.
 * See SafeObject. This is a proprietary element.
 */
class HTMLPurifier_HTMLModule_SafeEmbed extends HTMLPurifier_HTMLModule {
	...
	public function setup($config) {
		$max = $config->get ( 'HTML.MaxImgLength' );
		$embed = $this->addElement ( 'embed', 'Inline', 'Empty', 'Common', array (
				'src*' => 'URI#embedded',
 ...
 * In theory, objects permitted by this module will
...
class HTMLPurifier_HTMLModule_SafeObject extends HTMLPurifier_HTMLModule {
	...
	public function setup($config) {
		...
		$param = $this->addElement ( 'param', false, 'Empty', false, array (
				'id' => 'ID',
				'name*' => 'Text',
				'value' => 'Text' 
		) );
 ...
 * No inline JS is allowed, and pointed to JS
...
class HTMLPurifier_HTMLModule_SafeScripting extends HTMLPurifier_HTMLModule {
	...
	public function setup($config) {
		...
		$script = $this->addElement ( 'script', 'Inline', 'Empty', null, array (
				// While technically not required by the spec, we're forcing
				// it to this value.
...
class HTMLPurifier_HTMLModule_Scripting extends HTMLPurifier_HTMLModule {
	...
	public function setup($config) {
		...
		$this->info ['script']->attr = array (
				'defer' => new HTMLPurifier_AttrDef_Enum ( array (
						'defer' 
				) ),
				'src' => new HTMLPurifier_AttrDef_URI ( true ),
...
class HTMLPurifier_HTMLModule_Tables extends HTMLPurifier_HTMLModule {
	...
	public function setup($config) {
		...
		$this->addElement ( 'table', 'Block', new HTMLPurifier_ChildDef_Table (), 'Common', array (
				'border' => 'Pixels',
				'cellpadding' => 'Length',
				'cellspacing' => 'Length',
...
class HTMLPurifier_HTMLModule_Text extends HTMLPurifier_HTMLModule {
	...
	public function setup($config) {
		...
		$this->addElement ( 'q', 'Inline', 'Inline', 'Common', array (
				'cite' => 'URI' 
		) );
		...
		$this->addElement ( 'blockquote', 'Block', 'Optional: Heading | Block | List', 'Common', array (
				'cite' => 'URI' 
		) );
...
class HTMLPurifier_HTMLModule_Tidy extends HTMLPurifier_HTMLModule {
	 ...
	 * the fixes array.
	 * It may be custom overloaded, used in conjunction
...
class HTMLPurifier_HTMLModule_Tidy_XHTMLAndHTML4 extends HTMLPurifier_HTMLModule_Tidy {
	...
	public function makeFixes() {
		...
		// @align for img -------------------------------------------------
		$r ['img@align'] = new HTMLPurifier_AttrTransform_EnumToCSS ( 'align', array (
				'left' => 'float:left;',
				'right' => 'float:right;',
		...
		// @align for table -----------------------------------------------
		$r ['table@align'] = new HTMLPurifier_AttrTransform_EnumToCSS ( 'align', array (
				'left' => 'float:left;',
		...
		$r ['table@bgcolor'] = $r ['td@bgcolor'] = $r ['th@bgcolor'] = new HTMLPurifier_AttrTransform_BgColor ();
		
		// @border for img ------------------------------------------------
		$r ['img@border'] = new HTMLPurifier_AttrTransform_Border ();
		
		// @clear for br --------------------------------------------------
		$r ['br@clear'] = new HTMLPurifier_AttrTransform_EnumToCSS ( 'clear', array (
				'left' => 'clear:left;',
				'right' => 'clear:right;',
				'all' => 'clear:both;',
				'none' => 'clear:none;' 
		...
		// @width for hr, td, th ------------------------------------------
		$r ['td@width'] = $r ['th@width'] = $r ['hr@width'] = new HTMLPurifier_AttrTransform_Length ( 'width' );
...
class HTMLPurifier_Injector_AutoParagraph extends HTMLPurifier_Injector {
	 ...
	 * 
	 * @param string $data
	 *        	String text data that will be processed
	 *        	into paragraphs
	 * @param HTMLPurifier_Token[] $result
	 *        	Reference to array of tokens that the
...
class HTMLPurifier_Injector_DisplayLinkURI extends HTMLPurifier_Injector {
	...
	public function handleEnd(&$token) {
		if (isset ( $token->start->attr ['href'] )) {
			...
			$token = array (
					$token,
					new HTMLPurifier_Token_Text ( " ($url)" ) 
			);
		} else {
			// nothing to display
		}
	...
	public function handleText(&$token) {
		...
		for($i = 0, $c = count ( $bits ), $l = false; $i < $c; $i ++, $l = ! $l) {
			if (! $l) {
				...
				$token [] = new HTMLPurifier_Token_Start ( 'a', array (
						'href' => $bits [$i] 
				) );
				$token [] = new HTMLPurifier_Token_Text ( $bits [$i] );
	...
	public function handleElement(&$token) {
		if ($token->name == 'object') {
			...
			foreach ( $this->addParam as $name => $value ) {
				$new [] = new HTMLPurifier_Token_Empty ( 'param', array (
						'name' => $name,
						'value' => $value 
				) );
			}
...
$tokens );
	...
	protected function createStartNode($node, &$tokens, $collect) {
		...
		if (! $node->childNodes->length) {
			...
			if ($collect) {
				$tokens [] = $this->factory->createStart ( $tag_name = $node->tagName, // somehow, it get's dropped
$attr );
			}
			return true;
		}
	 ...
	 *
	 * @param DOMNamedNodeMap $node_map
...
class HTMLPurifier_Lexer_DirectLex extends HTMLPurifier_Lexer {
	...
	public function tokenizeHTML($html, $config, $context) {
		...
		if ($config->get ( 'HTML.Trusted' )) {
			$html = preg_replace_callback ( '#(<script[^>]*>)(\s*[^<].+?)(</script>)#si', array (
					$this,
					'scriptCallback' 
			), $html );
		}
...
class HTMLPurifier_Node_Comment extends HTMLPurifier_Node {
	...
	public function toTokenPair() {
		return array (
				new HTMLPurifier_Token_Comment ( $this->data, $this->line, $this->col ),
				null 
		);
	}
}
...
class HTMLPurifier_Node_Element extends HTMLPurifier_Node {
	...
	public function toTokenPair() {
		...
		if ($this->empty) {
			return array (
					new HTMLPurifier_Token_Empty ( $this->name, $this->attr, $this->line, $this->col, $this->armor ),
					null 
			);
		} else {
...
class HTMLPurifier_Node_Text extends HTMLPurifier_Node {
	...
	public function toTokenPair() {
		return array (
				new HTMLPurifier_Token_Text ( $this->data, $this->line, $this->col ),
				null 
		);
	}
}
...
class HTMLPurifier_Strategy_MakeWellFormed extends HTMLPurifier_Strategy {
	 ...
	 *
	 * @param HTMLPurifier_Token|array|int|bool $token
	 *        	Token substitution value
	 * @param HTMLPurifier_Injector|int $injector
	...
	private function insertBefore($token) {
		...
		// differences
		$splice = $this->zipper->splice ( $this->token, 0, array (
				$token 
		) );
	 ...
	 * Cursor now points to new token occupying previously
 ...
 * and possibly add some styling.
 * This will cover most of the deprecated
 * tag cases.
 */
...
class HTMLPurifier_URIScheme_file extends HTMLPurifier_URIScheme {
	 ...
	 * accessing files on the local machine is very common.
	 * In fact,
 ...
 * users.
 * This may not be able to represent all possible data inputs,
 * however.
 */

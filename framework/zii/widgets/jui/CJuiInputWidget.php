...
abstract class CJuiInputWidget extends CJuiWidget {
	...
	/**
	 * Resolves name and ID of the input.
	 * Source property of the name and/or source property of the attribute
	 * could be customized by specifying first and/or second parameter accordingly.
	 * 
	 * @param string $nameProperty
	 *        	class property name which holds element name to be used. This parameter
	 *        	is available since 1.1.14.
	 * @param string $attributeProperty
	 *        	class property name which holds model attribute name to be used. This
	...
	protected function resolveNameID($nameProperty = 'name', $attributeProperty = 'attribute') {
		...
		elseif ($this->hasModel ())
			...
			throw new CException ( Yii::t ( 'zii', '{class} must specify "model" and "{attribute}" or "{name}" property values.', array (

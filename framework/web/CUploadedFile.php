...
class CUploadedFile extends CComponent {
	 ...
	 *        	the attribute name. For tabular file uploading, this can be in the format of "[$i]attributeName", where $i stands for an integer index.
	 ...
	 * 
	 * @param string $key
	 *        	key for identifiing uploaded file: class name and subarray indexes
	 * @param mixed $names
	 *        	file names provided by PHP
	 * @param mixed $tmp_names
	 *        	temporary file names provided by PHP
	 * @param mixed $types
	 *        	filetypes provided by PHP
	 * @param mixed $sizes
	 *        	file sizes provided by PHP
	 * @param mixed $errors
	 *        	uploading issues provided by PHP
	 */
	 ...
	 * @param string $type
	 *        	the MIME-type of the uploaded file (such as "image/gif").
	 * @param integer $size

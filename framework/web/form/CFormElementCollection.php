...
class CFormElementCollection extends CMap {
	 ...
	 * 
	 * @param CForm $form
	 *        	the form object that owns this collection
	 * @param boolean $forButtons
	 *        	whether this collection is used to store buttons.
	 */
				...
				} elseif (! strcasecmp ( substr ( $value ['type'], - 4 ), 'form' )) // a form
{
			...
			$element = new CFormStringElement ( array (
					'content' => $value 
			), $this->_form );
	 ...
	 * 
	 * @param string $key
	 *        	the name of the element to be removed from the collection
	 */

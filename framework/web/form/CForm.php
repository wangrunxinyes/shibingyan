...
class CForm extends CFormElement implements ArrayAccess {
	 ...
	 * 
	 * @param mixed $config
	 *        	the configuration for this form. It can be a configuration array
	 ...
	 * @param CModel $model
	 *        	the model object associated with this form. If it is null,
	 *        	the parent's model will be used instead.
	 * @param mixed $parent
	 *        	the direct parent of this form. This could be either a {@link CBaseController}
	 ...
	 *        	whether to call {@link loadData} if the form is submitted so that
	 ...
	 *        	whether to return parent's model if this form doesn't have model by itself.
	 ...
	 *
	 * @param CModel $model
	 *        	the model to be associated with this form
	 */
	 ...
	 * 
	 * @param mixed $element
	 *        	the form element to be rendered. This can be either a {@link CFormElement} instance
	 ...
	 * @param boolean $forButtons
	 *        	whether the element is added to the {@link buttons} collection.
	 ...
	 * @param boolean $forButtons
	 *        	whether the element is removed from the {@link buttons} collection

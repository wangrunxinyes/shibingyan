...
class CHttpRequest extends CApplicationComponent {
	...
	protected function normalizeRequest() {
		...
		if ($this->enableCsrfValidation)
			Yii::app ()->attachEventHandler ( 'onBeginRequest', array (
					$this,
					'validateCsrfToken' 
			) );
	}
	 ...
	 * @param mixed $defaultValue
	 *        	the default parameter value if the POST parameter does not exist.
	 ...
	 * 
	 * @param string $name
	 *        	the DELETE parameter name
	 * @param mixed $defaultValue
	 *        	the default parameter value if the DELETE parameter does not exist.
	 ...
	 * 
	 * @param string $name
	 *        	the PUT parameter name
	 * @param mixed $defaultValue
	 *        	the default parameter value if the PUT parameter does not exist.
	 ...
	 * @param mixed $defaultValue
	 *        	the default parameter value if the PATCH parameter does not exist.
	 ...
	 * 
	 * @param string $value
	 *        	the schema and host part of the application URL.
	 */
			...
			} elseif (isset ( $_SERVER ['ORIG_PATH_INFO'] )) // IIS 5.0 CGI
{
	 ...
	 * 
	 * @param string $url
	 *        	URL to be redirected to. Note that when URL is not
	 ...
	 *        	the HTTP status code. Defaults to 302. See {@link http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html}
	 ...
	 * 
	 * @param string $header
	 *        	the accept header value to parse
	 ...
	 * 
	 * @param array $a
	 *        	user accepted MIME type as an array map
	 * @param array $b
	 *        	user accepted MIME type as an array map
...
class CCookieCollection extends CMap {
	 ...
	 *        	Cookie name.
	 * @param array $options
	 *        	Cookie configuration array consisting of name-value pairs, available since 1.1.11.

...
class CActiveForm extends CWidget {
	...
	public function error($model, $attribute, $htmlOptions = array(), $enableAjaxValidation = true, $enableClientValidation = true) {
		...
		if ($enableClientValidation) {
			$validators = isset ( $htmlOptions ['clientValidation'] ) ? array (
					$htmlOptions ['clientValidation'] 
			) : array ();
			...
			if (($pos = strrpos ( $attribute, ']' )) !== false && $pos !== strlen ( $attribute ) - 1) // e.g. [a]name
{
	...
	public function errorSummary($models, $header = null, $footer = null, $htmlOptions = array()) {
		...
		foreach ( is_array ( $models ) ? $models : array (
				$models 
		) as $model )
	 ...
	 * 
	 * @param mixed $models
	 *        	a single model instance or an array of models.
	 ...
	 *        	whether to load the data from $_POST array in this method.

...
<div class="row sticky">
		...
		<div class="tooltip">The database component that should be used.</div>
...
<div class="row">
		...
		<div class="tooltip">Whether comments specified for the table columns
		should be used as the new model's attribute labels. In case your RDBMS
		doesn't support feature of commenting columns or column comment wasn't
		set, column name would be used as the attribute name base.</div>

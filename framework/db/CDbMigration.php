...
abstract class CDbMigration extends CComponent {
	 ...
	 * @param array $params
	 *        	input parameters (name=>value) for the SQL execution. See {@link CDbCommand::execute} for more details.
	 * @since 1.1.7
	 */
	 ...
	 *        	the table that new rows will be inserted into.
	 * @param array $data
	 *        	an array of various column data (name=>value) to be inserted into the table.
	 * @since 1.1.16
	 */
	...
	public function addForeignKey($name, $table, $columns, $refTable, $refColumns, $delete = null, $update = null) {
		echo "    > add foreign key $name: $table (" . (is_array ( $columns ) ? implode ( ',', $columns ) : $columns) . ") references $refTable (" . (is_array ( $refColumns ) ? implode ( ',', $refColumns ) : $refColumns) . ") ...";
		$time = microtime ( true );
	 ...
	 * 
	 * @param string $name
	 *        	name of the primary key constraint to add
	 * @param string $table
	 *        	name of the table to add primary key to
	 * @param string|array $columns
	 ...
	 * @param string $table
	 *        	name of the table to remove primary key from
	 * @since 1.1.13
	 */

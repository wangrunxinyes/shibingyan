...
class CDbConnection extends CApplicationComponent {
	 ...
	 * @see http://www.php.net/manual/en/function.PDO-construct.php Note that if you're using GBK or BIG5 then it's highly recommended to
...
;
	...
	public function getSchema() {
		if ($this->_schema !== null)
			...
			if (isset ( $this->driverMap [$driver] ))
				...
				throw new CDbException ( Yii::t ( 'yii', 'CDbConnection does not support reading schema for {driver} database.', array (
						'{driver}' => $driver 
				) ) );
		}
	}
	...
	/**
	 * Changes the name of the DB driver.
	 * Overrides value extracted from the {@link connectionString},
	 * which is behavior by default.
	 * 
	 * @param string $driverName
	 *        	to be set. Valid values are the keys from the {@link driverMap} property.
	 * @see getDriverName
	 * @see driverName
	 * @since 1.1.16
	 */

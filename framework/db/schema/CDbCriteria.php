...
class CDbCriteria extends CComponent {
	 ...
	 *        	the column name (or a valid SQL expression)
	 * @param array $values
	 *        	list of values that the column value should not be in
	 * @param string $operator
	 *        	the operator used to concatenate the new condition with the existing one.
	 *        	Defaults to 'AND'.
	 * @return static the criteria object itself
	 ...
	 *        	Defaults to 'AND'.
	 * @param boolean $escape
	 *        	whether the value should be escaped if $partialMatch is true and
	 ...
	 *        	the criteria to be merged with. Either an array or CDbCriteria.
	 * @param string|boolean $operator
	 *        	the operator used to concatenate where and having conditions. Defaults to 'AND'.

...
EOD;
	...
	public function createIndex($name, $table, $columns, $unique = false) {
		...
		if ($unique) {
			return 'ALTER TABLE ONLY ' . $this->quoteTableName ( $table ) . ' ADD CONSTRAINT ' . $this->quoteTableName ( $name ) . ' UNIQUE (' . implode ( ', ', $cols ) . ')';
		} else {

...

{
	 ...
	 *        	
	 * @param mixed $config
	 *        	application configuration. This parameter will be passed as the parameter
	 *        	
	 ...
	 *        	the application instance. If this is null, the existing
	 *        	
	 ...
	 *
	 * @param string $alias
	 *        	path alias to be imported
	 *        	
	 * @param boolean $forceInclude
	 *        	whether to include the class file immediately. If false, the class file
	 *        	
	 ...
	 *
	 * @param string $alias
	 *        	alias (e.g. system.web.CController)
	 *        	
	 ...
	 *        	
	 * @param string $path
	 *        	the path corresponding to the alias. If this is null, the corresponding
	 *        	
	 ...
	 *        	whether to load classes via classmap only
	 *        	
	...
	{
		return Yii::t ( 'yii', 'Powered by {yii}.', array (
				'{yii}' => '<a href="http://www.yiiframework.com/" rel="external">Yii Framework</a>' 
		) );
	}
	 ...
	 *
	 * @param string $category
	 *        	message category. Please use only word letters. Note, category 'yii' is
	 *        	
	 ...
	 *        	
	 * @param array $params
	 *        	parameters to be applied to the message using <code>strtr</code>.
	 *        	
	 ...
	 *        	
	 * @param string $source
	 *        	which message source application component to use.
	 *        	
	 ...
	 *        	the target language. If null (default), the {@link CApplication::getLanguage application language} will be used.
	 *        	
	 ...
	 *        	a valid PHP callback (function name or array($className,$methodName)).
	 *        	
	 * @param boolean $append
	 *        	whether to append the new autoloader after the default Yii autoloader.
	 *        	

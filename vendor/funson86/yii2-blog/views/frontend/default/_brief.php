...
<div class="post">
    ...
    <div class="nav">
        ...
        <i class="icon-comment"></i><?= Html::a("{$data->commentsCount} Comments", $data->url.'#comments'); ?>
        <i class="icon-smiley"></i><?= $data->click; ?> viewers
    </div>
    <div class="content">
        <?php
    ...
    <span class="more"><?= Html::a('Read more', $data->url, array('target'=>'_blank', 'title'=>Html::encode($data->title))); ?></span>
    <div class="clear"></div>
</div>